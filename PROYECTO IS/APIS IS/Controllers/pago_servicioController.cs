...
{
    public class pago_servicioController : Controller
    {
        ...
        // GET: pago_servicio/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: pago_servicio/Create
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que quiere enlazarse. Para obtener 
        // más detalles, vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "pk_id_pago_servicio,fk_tipo_servicio,fk_id_cuenta_bancaria,cantidad,no_documento,no_autorizacion,fecha_realizo,cuenta_debitada,total_pagar")] pago_servicio pago_servicio)
        {
